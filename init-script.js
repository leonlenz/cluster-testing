...
// CONFIG
const API_BASE_URL   = __ENV.API_BASE_URL   || 'https://charmed-javelin.api.whispchat.com';
const WS_URL         = __ENV.WS_URL         || 'wss://charmed-javelin.api.whispchat.com/api/wsConnect';
