...
// CONFIG
const API_BASE_URL   = __ENV.API_BASE_URL   || 'https://darling-anchovy.api.whispchat.com';
const WS_URL         = __ENV.WS_URL         || 'wss://darling-anchovy.api.whispchat.com/api/wsConnect';
